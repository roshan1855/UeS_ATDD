Feature: Quotes Module
  ...
  @Quote @Regression_UeS @AddNewQuote_Dnetal_Vision_Life_Without_Salary @July_UeS
  ...
  @Quote @Regression_UeS @AddNewQuote_Dnetal_Vision_Life_With_Salary_with_DEP @July_UeS
  ...
  @Quote @Regression_UeS @AddNewQuote_Dnetal_Vision_With_Salary_with_DEP @Suri
  ...
  @Quote @Regression_UeS @AddNewQuote_Dnetal_Vision_Without_Salary @Suri
